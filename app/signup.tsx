...
export default function SignupScreen() {
  const { signup, checkPatientOnboardingComplete, user } =
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (role === 'patient') {
        const onboardingComplete = await checkPatientOnboardingComplete(
          user.id
        );
        ...
        router.replace('/login'); // after onboarding is complete
      } else if (role === 'doctor') {
